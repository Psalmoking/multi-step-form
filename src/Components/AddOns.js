        ...
        <form className={classes.form} onSubmit={formSubmitHandler}>
          <div
            className={`${classes.addon} ${
              selectedAddons["Online service"] ? classes.selected : ""
            }`}
          >
            <input
              type="checkbox"
              ...
              defaultChecked={selectedAddons["Online service"]}
            />
            <div>
          ...
          <div
            className={`${classes.addon} ${
              selectedAddons["Larger storage"] ? classes.selected : ""
            }`}
          >
            <input
              type="checkbox"
              ...
              onClick={checkHandler}
              defaultChecked={selectedAddons["Larger storage"]}
            />
            <div>
              <div className={classes.description}>
          ...
          <div
            className={`${classes.addon} ${
              selectedAddons["Customizable profile"] ? classes.selected : ""
            }`}
          >
            <input
              type="checkbox"
              ...
              onClick={checkHandler}
              defaultChecked={selectedAddons["Customizable profile"]}
            />
            <div>
              <div className={classes.description}>
